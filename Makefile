build:
	g++ -std=c++11 -o project2.out src/main.cpp src/Algorithms.cpp
...
run:
	...
	./project2.out output/part4.tga input/circles.tga multiply input/layer2.tga subtract input/pattern2.tga
